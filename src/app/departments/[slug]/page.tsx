...
import { BookOpen, FlaskConical, Users, ArrowRight, GraduationCap } from 'lucide-react';
...
export default async function DepartmentDetailPage({ params }: DepartmentPageProps) {
  ...
  const [department, appearance] = await Promise.all([
          ...
          <div className={cn(
            ...
            {isTheme3 ? (
              <div className="space-y-6">
                <span className="text-[#cc2936] text-sm font-bold tracking-[0.4em] uppercase block animate-in fade-in slide-in-from-left-4 duration-700">School of Training</span>
      ...
      <div className="container mx-auto px-4 py-16 md:px-6 lg:py-24">
        ...
        <div className="grid gap-16 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            <div className="flex items-center gap-4 border-b border-gray-100 pb-6">
               ...
               <h2 className={cn("text-3xl font-bold uppercase font-headline tracking-tight", isTheme3 ? "text-navy" : "")}>Departmental Faculty</h2>
            </div>
          ...
          <div className="lg:col-span-4 space-y-12">
            {/* Research Areas */}
            <div className="space-y-6">
              <h2 className={cn("text-2xl font-bold uppercase font-headline tracking-tight", isTheme3 ? "text-navy" : "")}>Research Areas</h2>
            ...
            {isTheme3 && (
              <div className="bg-[#0d1b3e] p-8 text-white space-y-6">
                 <h3 className="text-xl font-bold font-headline uppercase tracking-wider text-[#cc2936]">Department Info</h3>
                 <div className="space-y-4">
                    <div className="flex items-center gap-4 text-sm">
                       <GraduationCap className="h-5 w-5 text-[#cc2936]" />
                       <span className="text-gray-300">Undergraduate & Masters</span>
                    </div>
                    <div className="flex items-center gap-4 text-sm">
                       <BookOpen className="h-5 w-5 text-[#cc2936]" />
                       <span className="text-gray-300">24 Featured Courses</span>
                    </div>
                    <div className="flex items-center gap-4 text-sm">
                       <FlaskConical className="h-5 w-5 text-[#cc2936]" />
                       <span className="text-gray-300">04 Specialized Labs</span>
                    </div>
                 </div>
        ...
        <div className="mt-24 space-y-12">
          <div className="flex items-center gap-4 border-b border-gray-100 pb-6">
             ...
             <h2 className={cn("text-3xl font-bold uppercase font-headline tracking-tight", isTheme3 ? "text-navy" : "")}>Featured Curriculum</h2>
          </div>
